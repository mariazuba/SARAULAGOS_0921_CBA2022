...
//LEER DATOS ".dat"	
 ...
 //========================================================
//-------------------------------------------------------------
//  Coeficiente de variaci?n de los desvios Rt, No 			
 init_vector cvar(1,2) //cv_Rt y cv_No
 init_vector dt(1,3)//dt_desove, cpue,reclan
//-------------------------------------------------------------
// Par?metros de crecimiento,alfa y beta relaci?n stock recluta,
...
//-------------------------------------------------------------
 ...
 init_vector fases_bio(1,7)//fases de estimaci?n Par_bio
...
//-------------------------------------
  ...
  number log_M_prior
  number log_h_prior
  //fases de estimaci?n par?metros
  number opt_Linf
  number opt_k
  number opt_Lo
  number opt_alfa
...
//--------------------------------------
 init_int    nbloques1 //n?mero de bloques de selectividad flota
 init_vector ybloques1(1,nbloques1)//a?o de inicio bloque de selectividad flota

 init_int    nbloques2//n?mero de bloques de selectividad RECLAN
 init_vector ybloques2(1,nbloques2)//a?o de inicio bloque de selectividad RECLAS

//--------------------------------------
// BLOQUES DE CAPTURABULIDAD CRUCEROS
//--------------------------------------
 init_int    nqbloques//n?mero de bloques de Capturabilidad cpue
 init_vector yqbloques(1,nqbloques)//a?o de inicio bloque de Capturabilidad cpue

 init_int    nqbloquesc//n?mero de bloques de Capturabilidad RECLAN
 init_vector yqbloquesc(1,nqbloquesc)//a?o de iniciobloque de Capturabilidad RECLAN
...
// Simulaci?n_proyecci?n
 init_int ntime_sim //A?os a simular en el futuro
 init_int pR
 init_int oprec
 init_number opt_sim //opci?n de simular o estimar (0=simula, 1=estima)	
...
//---------------------------------------------------------------------------
// Estructura inicial en equilibrio para el primer a?o
//---------------------------------------------------------------------------
 Neq(1) = No(1);
...
//========================================================================
 ...
 Brms(i)=Bo*(ratio_spr(i)-0.05);
   ...
   //Frpr   = elem_div(mfexp(log_F),Frms_bloque);
    Frpr   = exp(log_F)/mfexp((log_Fref(3))); 
...
// proyectado desde RECLAN para el mismo a?o
  CBA(j) = YTP(j);

// proyectado desde fin de a?o al proximo
