...
kable(data.frame(Edades=data.0$Edades,
...
plot(c(rep0$YRS,seq(yearProy,yearProy,1)),
     ...
     ylim=c(0,95000),xlim=c(2000,2023),pch=19,main="")
...
plot(c(rep0$YRS,seq(yearProy,yearProy,1)),
     ...
     type="o",ylab="BD/BDrms",col=3,xlab="Años",pch=19,xlim=c(2000,2023),)
...
```{r Fig9Escenarios,warning=F, include=T, message=F, echo=FALSE,fig.height=4,fig.width=6,fig.align="center"}
...
plot(seq(2006,2020,1),propCapt,type="o",xlim=c(2006,2021),xlab="Años",ylab="Proporción de captura sept a dic")
...
#==========================================================================
  ...
  #--------------
  # escenario 4: S1 +	Desembarque 2020
  #--------------
  dat<- data
  dat$Ind[20,2] <- 9794
...
colnames(probEstatus)<-c("Captura_1",'Captura_2','Captura_3')
kable(probEstatus)
#######################################################################################
...
lines(c(reps1a$YRS,seq(yearProy,yearProy,1)),
      c(reps2a$Reclutas,reps3a$Rproy),type="o",col=3,pch=19)

lines(c(reps1a$YRS,seq(yearProy,yearProy,1)),
      c(reps2a$Reclutas,reps1a$Rproy),type="o",col=1,pch=19)
...
abline(v=yearProy-1,lty=2)
legend(2011,95000,c("Captura_1","Captura_2","Captura_3"),pch=19,lwd=1,col=c(2,1,3),bty="n")
...
plot(tallas,reps1a$CTPp,type="l",ylim=c(0,900),main="",
     ...
     cex.axis=1,cex.main=1,cex.lab=1,col='blue2')
lines(tallas,reps2a$CTPp,col='red2')
lines(tallas,reps3a$CTPp,col='green2')
...
legend(2000,0.00021,
       c(paste("CBA2022_Hito1_Capt1 = [",round(icca[1],0),"-",round(icca[2],0),"]",sep=" "),
         paste("CBA2022_Hito1_Capt2 = [",round(iccb[1],0),"-",round(iccb[2],0),"]",sep=" "),
         paste("CBA2022_Hito1_Capt3 = [",round(iccc[1],0),"-",round(iccc[2],0),"]",sep=" ")), lty=c(1,1,1),col=c('blue2',"red2","green2"),bty="n",lwd=1,cex=0.8)
box()
...
legend(12,13000,c("Capt1","Capt2","Capt3"),
...
lines(c(rep0$YRS,seq(yearProy,yearProy,1)),
      c(reps4a$BD,bds4),type="o",col=4,pch=19)

abline(v=yearProy-1,lty=2)
legend(2011,95000,c("Captura_1","Captura_2","Captura_3","Captura_4"),pch=19,lwd=1,col=c(2,1,3,4),bty="n")
...
lines(tallas,reps2a$CTPp,col='red2')
lines(tallas,reps3a$CTPp,col='green2')
lines(tallas,reps4a$CTPp,col=1)
#text(rep(9.5,3),c(reps1a$CTPp[10],reps2a$CTPp[10],reps3a$CTPp[10])+10,c('8%','18%','5%'))
#===============================================================================================================
# plot densidad de probabilidad CBA
plot(xca,yca,type="l",ylab="Densidad de probabilidad",xaxs="i",yaxs= "i",ylim=c(0,0.00022),xlim=c(1000,21000),xlab="CBA 2022 (toneladas)",
...
lines(xcd,ycd,lwd=1,col=1,lty=1)

legend(2000,0.00021,
       c(paste("CBA2022_Hito1_Tallas1 = [",round(icca[1],0),"-",round(icca[2],0),"]",sep=" "),
         paste("CBA2022_Hito1_Tallas2 = [",round(iccb[1],0),"-",round(iccb[2],0),"]",sep=" "),
         paste("CBA2022_Hito1_Tallas3 = [",round(iccc[1],0),"-",round(iccc[2],0),"]",sep=" "),
         paste("CBA2022_Hito1_Tallas4 = [",round(iccd[1],0),"-",round(iccd[2],0),"]",sep=" ")), lty=c(1,1,1),col=c('blue2',"red2","green2",'black'),bty="n",lwd=1,cex=0.8)
box()
...
lines(seq(10,50,10),CBAs2a,type="o",col="red2")
lines(seq(10,50,10),CBAs3a,type="o",col="green2")
lines(seq(10,50,10),CBAs4a,type="o",col="black")

legend(12,13000,c("Tallas1","Tallas2","Tallas3","Tallas4"),
       col=c(4,2,3,1),pch=c(19,19,19,19),lwd=1,bty="n",cex=0.8)
