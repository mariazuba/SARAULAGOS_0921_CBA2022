...
### 1. Escenarios de reclutamiento para proyección
```{r Fig23_anexoIII,warning=F, include=T, message=F, echo=F,fig.height=4,fig.width=7,fig.align="center",fig.path="Figuras/",dev=c('pdf')}
...
```{r Fig27_anexoIII,warning=F, include=T, message=F, echo=F,fig.height=8,fig.width=8,fig.align="center",fig.path="Figuras/",dev=c('pdf')}
