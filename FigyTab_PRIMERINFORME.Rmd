...
bds1     <- subset(stds1,name=="SSBp")$value[3] ; bds1std  <- subset(stds1,name=="SSBp")$std[3] #reclutamiento medios
bds2     <- subset(stds2,name=="SSBp")$value[3] ; bds2std  <- subset(stds2,name=="SSBp")$std[3] #reclutamiento 2018
bds3     <- subset(stds3,name=="SSBp")$value[3] ; bds3std  <- subset(stds3,name=="SSBp")$std[3] #reclutamiento 2012

cs1     <- subset(stds1,name=="CBAp")$value[3] ; cs1std  <- subset(stds1,name=="CBAp")$std[3] #reclutamiento medios
cs2     <- subset(stds2,name=="CBAp")$value[3] ; cs2std  <- subset(stds2,name=="CBAp")$std[3] #reclutamiento 2018
cs3     <- subset(stds3,name=="CBAp")$value[3] ; cs3std  <- subset(stds3,name=="CBAp")$std[3] #reclutamiento 2012
