    ...
    \vspace{5mm}
       \begin{minipage}{\textwidth}
        \parbox[t]{0.9\linewidth}{
            ...
            Estatus y Posibilidades de Explotación Biológicamente Sustentables  \\ de  Sardina austral de la  Región de Los Lagos, año 2021 
			\end{flushright} 
...
\centering \fontsize{9pt}{8pt}\selectfont
            ...
            Sardina austral de la  Región de Los Lagos, año 2021 
              \end{flushright} 
            \vspace*{-5mm} 
            \hfill \textbf{SUBSECRETARIA DE ECONOMIA Y EMT / Septiembre 2021}
